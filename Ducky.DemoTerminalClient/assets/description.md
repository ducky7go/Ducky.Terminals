...
* **QQ Group**: 755123281
* **Group Link**: [逃离鸭科夫 鸭神降临 mod 技术交流](https://qm.qq.com/q/TjBZSgMOqK)
...
作为 mod 作者，如果你要想为你的 mod 集成进入控制台，可以查看 [https://github.com/ducky7go/Ducky.Terminals](https://github.com/ducky7go/Ducky.Terminals) 来获取对接帮助。
## 🔗 社群支持
